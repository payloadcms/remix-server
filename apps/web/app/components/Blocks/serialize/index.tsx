// from https://github.com/payloadcms/public-demo/blob/master/src/app/_components/RichText/serialize/index.tsx
    ...
    <Fragment>
      {nodes?.map((_node, index): JSX.Element | null => {
        ...
        switch (_node.type) {
          ...
          case 'label':
            return <p key={index} className="label">{serializedChildren}</p>

          case 'largeBody': {
            return <p key={index} className="large-body">{serializedChildren}</p>
          }
          case 'list': {
